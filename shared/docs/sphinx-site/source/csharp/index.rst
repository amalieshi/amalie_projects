...
.. grid:: 1 2 2 2
   ...
   .. grid-item-card:: **Desktop Applications**
      :text-align: center
      :class-card: tech-card
   ...
   .. grid-item-card:: **Architecture & Patterns**
      :text-align: center
      :class-card: tech-card
...
.. list-table:: C# Skills Development
   :widths: 40 20 20 20
   :header-rows: 1
...
**Want to explore the code?** Check out my C# projects in the `csharp/ <https://github.com/yourusername/amalie_projects/tree/main/csharp>`_ folder of my repository.
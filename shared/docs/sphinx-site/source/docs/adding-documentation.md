...
- `index.md` - Main documentation index page
- `git-philosophy.md` - Git workflow documentation  
- `learning-paths.md` - Learning path guides
- `adding-documentation.md` - This guide (you are here!)
- `local-development.md` - Local development workflow guide
